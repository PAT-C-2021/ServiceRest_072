...
namespace ServiceRest_20190140072_AnisaNurfadila
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data source=DESKTOP-8OQRTV4; Initial Catalog=\"TI UMY\"; Persist Security Info = True;User ID=sa;Password=123"); // Authentication=Windows Authentication
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data source=DESKTOP-8OQRTV4; Initial Catalog=\"TI UMY\"; Persist Security Info = True;User ID=sa;Password=123"); // Authentication=Windows Authentication
